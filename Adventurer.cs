...
namespace Quest
{
    ...
    public class Adventurer
    {
        ...
        public Adventurer(string name, Robe PlayersRobe)
        {
            Name = name;
            Awesomeness = 50;
        ...
        {
            return $"The adventurer {Name} is wearing a robe that is {string.Join(", ", ColorfulRobe.Colors)} and {ColorfulRobe.Length} inches.";
        }
